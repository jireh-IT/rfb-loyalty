...
import com.jireh.repository.LocationRepository;
import com.jireh.service.LocationService;
...
/**
 * REST controller for managing {@link com.jireh.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    public ResponseEntity<List<LocationDTO>> getAllLocations(
        ...
        if ("rfbuser-is-null".equals(filter)) {
            log.debug("REST request to get all Locations where rfbUser is null");
            return new ResponseEntity<>(locationService.findAllWhereRfbUserIsNull(), HttpStatus.OK);
        }
