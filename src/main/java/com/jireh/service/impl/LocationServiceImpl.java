...
public class LocationServiceImpl implements LocationService {
    ...
    /**
     *  Get all the locations where RfbUser is {@code null}.
     *  @return the list of entities.
     */
    @Transactional(readOnly = true)
    public List<LocationDTO> findAllWhereRfbUserIsNull() {
        log.debug("Request to get all locations where RfbUser is null");
        return StreamSupport
            .stream(locationRepository.findAll().spliterator(), false)
            .filter(location -> location.getRfbUser() == null)
            .map(locationMapper::toDto)
