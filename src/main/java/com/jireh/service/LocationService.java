...
/**
 * Service Interface for managing {@link com.jireh.domain.Location}.
 */
public interface LocationService {
    ...
    /**
     * Get all the LocationDTO where RfbUser is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<LocationDTO> findAllWhereRfbUserIsNull();
