...
import { EventAttendanceDeleteDialogComponent } from './event-attendance-delete-dialog.component';
...
describe('EventAttendance Management Delete Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, EventAttendanceDeleteDialogComponent],
